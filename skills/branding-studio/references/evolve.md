# EVOLVE — change the smallest layer that no longer serves

Use EVOLVE when a committed strategy, direction or system may need material change. Preserve valid equity; reopen only the layer that the best available evidence actually challenges.
