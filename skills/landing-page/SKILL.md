...
- `references/verification.md` — before completing any material CREATE/REFINE when browser/rendering tools are available: falsifiers/oracles, state-aware evidence, build-render loop, QA, critique lenses, severity, stop rule.
