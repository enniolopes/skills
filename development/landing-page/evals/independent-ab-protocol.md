# Independent A/B protocol — landing-page v3.1 vs v3.5.1

Purpose: test whether v3.5.1 improves long-horizon coherence, productive pivot behavior, evidence fit, resistance to counterfeit quality, and decision generalization from fewer competing rules without reducing creative strength or producing omissions/anti-template behavior.
...
- **Candidate B:** repository `enniolopes/skills` at commit `9487feea1e9ae5a78684a071988d71ec3161e658` (`landing-page-v3.2-control-plane`, landing-page v3.5.1 experimental runtime).
...
- whether either result omitted relevant work because its internal decision model was too abstract;
...
Do not reward use of internal vocabulary such as `TRUTH`, `DIRECTION`, `RE-DIVERGE`, `counterfeit quality`, or architecture terminology. Reward outcomes only.
...
## Battery A3 — decision-model boundary regressions
...
- Did instruction compression make outputs simpler in a way that loses relevant expressive media, proof, narrative or craft?
...
Do not merge v3.5.1 because it is shorter, more internally elegant, wins process metrics, or wins targeted guardrails alone.

Prefer v3.5.1 only when all are true:
...
4. decision-model cases show no loss of decision coverage or decodability;
...
- decision-model guardrails: no severe failure and at least 3 of 4 cases satisfy intended behavior, including `inactive-medium-does-not-need-a-plan-field`;
